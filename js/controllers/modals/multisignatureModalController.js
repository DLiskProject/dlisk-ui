...
angular.module('dliskApp').controller('multisignatureModalController', ["$scope", "$http", "multisignatureModal", "viewFactory", "userService", "feeService", "gettextCatalog", function ($scope, $http, multisignatureModal, viewFactory, userService, feeService, gettextCatalog) {
    ...
    $scope.addMember = function (member) {
        ...
        if ($scope.member.trim() == '') {
            ...
            if (buffer.length == 32) {
                ...
                var address = dlisk.crypto.getAddress($scope.member);
