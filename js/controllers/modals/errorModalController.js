...
angular.module('dliskApp').controller('errorModalController', ["$scope", "errorModal", "userService", 'gettextCatalog', function ($scope, errorModal, userService, gettextCatalog) {
