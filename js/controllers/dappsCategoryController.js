...
angular.module('dliskApp').controller('dappsCategoryController', ['$scope', 'viewFactory', '$http', '$stateParams', 'dappsService', '$timeout', 'gettextCatalog', function ($scope, viewFactory, $http, $stateParams, dappsService, $timeout, gettextCatalog) {
